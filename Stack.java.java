...
// Single-file submission: public Stack class + package-private StackDriver driver
// Implements a generic stack with push, pop, top, isEmpty, size and automatic resizing.
...
/* Driver for demonstrating the Stack implementation.
   ...
   (Class with main is allowed to be non-public.)
*/
class StackDriver {
